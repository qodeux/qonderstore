...
const Checkout = () => {
  ...
  const { control, handleSubmit, watch, setValue, clearErrors, setError, trigger, getValues, formState } = checkoutForm
    ...
    <FormProvider {...checkoutForm}>
      ...
      >
        ...
        <div className='flex-grow'>
          ...
          {canShipToCP && (
            <>
              {/* TODO:Implementar componente AddressFinder */}
              <AddressFinder />
                      ...
                      description={
                        <div className='text-xs'>
                          {watchDeliveryType === 'standard' && (
                            <p>
                              Una vez que tu pago sea <strong>acreditado</strong>, procesaremos tu pedido y lo incluiremos en la próxima
                              ruta de entrega disponible, te enviaremos un mensaje de confirmación. Los tiempos de entrega pueden variar
                              según la disponibilidad y la ubicación. Te notificaremos si hay algún cambio o contratiempo.
                            </p>
                          )}
                          {watchDeliveryType === 'custom' && (
                            <p>
                          ...
                          {watchDeliveryType === 'express' && (
                            <p>
                              Nuestro equipo te contactará para coordinar la entrega lo <strong>antes posible</strong>. Ten en cuenta que
                              las entregas express pueden tener un <strong>costo adicional</strong> y están sujetas a la disponibilidad del
